...
class Geoengine < Formula
  ...
  on_macos do
    on_intel do
      ...
      sha256 "a5f20d1830a08ad0fe7114d01062ff0b4af4e0512ddd5e863f4600d6091e493d"
    end

    on_arm do
      url "https://github.com/NikaGeospatial/geoengine/releases/download/v#{version}/geoengine-darwin-aarch64.tar.gz"
      sha256 "73d7fb96fc4109eb93466d5a9cd19ab6f9e77a9fd2b8bf660fec3df6a1ad0e2e"
    end
  end
  ...
  on_linux do
    on_intel do
      ...
      sha256 "f0ba3e68556736e4dd310d1d4bcbba9ed83d9dc3564a790873ad057d59256a60"
    end

    on_arm do
      url "https://github.com/NikaGeospatial/geoengine/releases/download/v#{version}/geoengine-linux-aarch64.tar.gz"
      sha256 "6813da7cc5ed4763561ce6b89cb20e55cfa4b503094018040b058a94210b91b4"
    end
  end
